                ...
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        @csrf
                            ...
                            <div class="form-group">
                                <select id="re_pass" name="user_type_id" class="zmdi zmdi-lock-outline" required>
                            ...
                            <div class="form-group primary-btn">
                                <input type="submit" name="signup" id="signup" class="form-submit" value="Register" style="background:#7fad39 !important;"/>
                            </div>
                        </form>
                    </div>
