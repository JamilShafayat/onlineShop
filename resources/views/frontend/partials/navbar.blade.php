    ...
    <header class="header" style="margin-top: -25px;">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="{{ asset('/home') }}"><img src="{{ asset('public/assets/img/logo.png') }}" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        ...
                        <div class="header__cart__price">item: <span>${{ isset($order) ? $order->total_amount : 0}}</span></div>
                    </div>
                </div>
            </div>
